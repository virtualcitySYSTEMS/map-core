...
import { createFeatureWithId, setupTransformationHandler } from './setupTransformationHandler.js';
...
describe('createTransformationHandler', () => {
  describe('reacting to feature selection in 3D', () => {
    ...
    beforeEach(async () => {
      map = getCesiumMap({});
      setup = await setupTransformationHandler(map, TransformationMode.TRANSLATE);
    });
