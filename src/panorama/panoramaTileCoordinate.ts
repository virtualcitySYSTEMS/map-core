 ...
 * @param level
 */
export function getNumberOfTiles(level: number): Size {
 ...
 * @param key
 */
export function createTileCoordinateFromKey(
  key: string,
): PanoramaTileCoordinate {
...
export function getTileCoordinatesInImageExtent(
  ...
  const tileCoordinates = new Array<PanoramaTileCoordinate>(
